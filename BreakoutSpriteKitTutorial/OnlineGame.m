...
- (void)selectNodeForTouch:(CGPoint)touchLocation {
	...
	if(![_selectedNode isEqual:touchedNode]) {
		...
		if([[touchedNode name] isEqualToString:Player1Name]||[[touchedNode name] isEqualToString:Player2Name]) {
            SKAction *sequence = [SKAction sequence:@[[SKAction rotateByAngle: [self degToRad:-4.0f]duration:0.1],[SKAction rotateByAngle:0.0 duration:0.1],[SKAction rotateByAngle:[self degToRad: 4.0f] duration:0.1]]];
